...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    firstName: '',
    lastName: '',
    userType: 'FREELANCER' as 'FREELANCER' | 'CLIENT' | 'BOTH',
    country: '',
    agreeToTerms: false,
  });
    ...
    <Card padding="lg" shadow="lg" className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        <Link href="/" className="inline-flex items-center gap-2 mb-4">
          <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-primary-600 to-purple-600" />
        ...
        <p className="mt-2 text-gray-600">{t('startLearningJourney')}</p>
      </div>
        ...
        <div>
          ...
          {formData.password && (
            <div className="mt-3 space-y-2">
              {[
                { key: 'length', label: t('validation.password.length') },
        ...
        <Input
          ...
          error={
            formData.confirmPassword && !passwordsMatch 
              ? t('errors.validation.passwordMismatch') 
              : undefined
          }
        />
            ...
            {[
              ...
              >
                <p className={`text-sm font-medium ${
                  formData.userType === option.value ? 'text-primary-600' : 'text-gray-700'
                }`}>
                  {option.label}
                </p>
              </button>
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">{t('signUpWith')}</span>
          </div>
        </div>
