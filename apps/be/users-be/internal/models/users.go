...
var UserWhere = struct {
	...
	TotalAmount: whereHelpertypes_Decimal{field: "\"users\".\"total_amount\""},
...
var (
	userAllColumns            = []string{"id", "user_id", "status", "total_amount", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"user_id", "total_amount"}
	userColumnsWithDefault    = []string{"id", "status", "created_at", "updated_at"}
