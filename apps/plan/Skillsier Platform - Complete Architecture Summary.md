# Skillsier Platform - Complete Architecture Summary
...
- Database: **PostgreSQL** (per service with auto-migrations)
- Cache: **Redis**
...
**Key Domains:**
- User accounts (integrated with Keycloak)
...
**Outbox Pattern:**
- Every service uses outbox pattern for reliable event publishing
...
All 11 microservices follow this structure:
...
1. **No SQL migration files**: All services use auto-migrations via GORM
...
4. **Keycloak integration**: All authentication goes through Keycloak
5. **Admin service**: Has clients for all other 10 services to perform admin operations
6. **Outbox pattern**: Used in all services for reliable event publishing
